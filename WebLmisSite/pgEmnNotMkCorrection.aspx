<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="pgEmnNotMkCorrection.aspx.cs" Inherits="pgEmnNotMkCorrection" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <asp:Panel ID="pnlreEditNamanjurSurvey" runat="server" ScrollBars="vertical" CssClass="bs_pnl"  Height="143px" Width="100%">
                                
                                <asp:GridView ID="gdvreEditNamanjurSurvey" runat="server" BorderWidth="1px" CssClass="grid"
                        ...
                        <br/>
    <div class="row">
    <CENTER><asp:Button id="btnSave"  runat="server" Text=" माहिती साठवा " CssClass="form_lbl" ToolTip="" Enabled="False" OnClick="btnSave_Click"></asp:Button>
