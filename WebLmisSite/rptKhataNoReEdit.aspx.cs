...
public partial class rptKhataNoReEdit : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            sb.Append("<thead>");
            sb.Append("<tr>");
            sb.Append("<td width='100%' valign='top' align='center'><font size='5' face='Sakal Marathi  ' color= purple><b>री-एडीट आज्ञावलीद्वारे खाता मास्टर दुरुस्तीचा माहिती उतारा</b></font></td>");
            sb.Append("</tr>");
            sb.Append("</thead>");
            sb.Append("</table>");
            sb.Append("</br >");
            ...
            if (dsNamesPins.Tables[0].Rows.Count > 0)
            {
                foreach (DataRow dr in dsNamesPins.Tables[0].Rows)
                {
                    ...
                    if (dsNamesPinsnew.Tables[0].Rows.Count > 0)
                    {
            ...
            {
                sb.Append("<tr width='100%' >");
                sb.Append("<td width='100%'  colspan='4' align='left'><center> <font size='4' face='Sakal Marathi  '  >&nbsp;<b> माहिती उपलब्ध नाही ..!!!!   </b></font></center> </td>");
                sb.Append("</tr >");
            }
