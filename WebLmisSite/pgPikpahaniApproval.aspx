<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMaster.master" AutoEventWireup="true" CodeFile="pgPikpahaniApproval.aspx.cs" Inherits="pgPikpahaniApproval" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

    <div >
                            <asp:Panel ID="pnlreEditPikpahaniConfirm" runat="server" ScrollBars="vertical" CssClass="bs_pnl"  Height="143px" Width="100%">
                                
                                <asp:GridView ID="gdvreEditPikpahaniConfirm" runat="server" BorderWidth="1px" CssClass="grid"
