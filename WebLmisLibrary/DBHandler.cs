...
namespace NIC.WebLMISLibrary
{
    public class DataBaseHandler
    {
        ...
        {
            _connectionString = (string)System.Configuration.ConfigurationManager.ConnectionStrings["District"+ databasename].ConnectionString.ToString();
        }
        #endregion
        ...
        public double ExecuteScalardouble(DbCommand Command)
        {
            NpgsqlConnection connection = null;
            NpgsqlTransaction transaction = null;
            NpgsqlCommand command = (NpgsqlCommand)Command;
