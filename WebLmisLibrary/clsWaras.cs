//1.21/12/2015  189 for processing waras mutation select currently only live names of dieseased person from from7_khata and holder_detail by putting condition marked <>'Y'
//2.21/12/2015  189 mut_no update in form7_khata of those records which are currently live of dieseased person from from7_khata  by putting condition marked <>'Y'
//3.21/12/2015  189 potkharaba not updated : retrive and insert potkharaba area
//4.11012016 update for tblrordetails 
//189
using System;
...
namespace NIC.WebLMISLibrary
{
    public class clsWaras
    {
        ...
        public string certifyWaras(objCertify waras, DbCommand dbCmd4)
        {
                ...
                loginid = objclscommonfunedit.funReturnSingleValue(waras.Database, waras.Schema + ".m_officermast", "username", "ccode='" + waras.Ccode + "' and user_type='2'", "");
                ...
                if (DS_MK.Tables[0].Rows.Count > 0)
                {
                    for (int x = 0; x <= DS_MK.Tables[0].Rows.Count - 1; x++)
                    {
                        ...
                        //2.21/12/2015 mut_no update in form7_khata of those records which are currently live of dieseased person from from7_khata  by putting condition marked <>'Y'
                        objclscommonfunedit.funUpdateValueSevarthID(waras.Database, waras.Schema + ".form7_khata", "marked='Y', old_mut_no=mut_no, mut_no='" + waras.Val + "'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "' ,' ','') and  marked<>'Y'", loginid, ref dbCmd4);
                        objclscommonfunedit.funUpdateValueSevarthID(waras.Database, waras.Schema + ".holder_detail", "marked='Y'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6]  + DS_MKS.Tables[0].Rows[0][7] +  DS_MKS.Tables[0].Rows[0][8] + "',' ','')", loginid, ref dbCmd4);
                        if (DS_MKS.Tables[0].Rows.Count > 0)
                        {
                            DS_F7K = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".form7_khata a," + waras.Schema + ".holder_detail b", "a.khata_no,b.khata_type,a.numeric_pin,a.pin,a.pin1,a.pin2,a.pin3,a.pin4,a.pin5,a.pin6,a.pin7,a.pin8,a.mut_no,count(*) as usrno,avg(a.total_area_h),avg(a.assessment),avg(a.anne),avg(a.pai),avg(a.potkharaba)", "a.ccode = b.ccode and a.khata_no = b.khata_no and a.ccode = '" + waras.Ccode + "' and replace(a.fname||a.mname||a.lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "',' ','') and a.marked<>'Y' and b.marked<>'Y' Group by a.khata_no,b.khata_type,a.numeric_pin,a.pin,a.pin1,a.pin2,a.pin3,a.pin4,a.pin5,a.pin6,a.pin7,a.pin8,a.mut_no", "");
                            DataSet dskhata_usrno = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".holder_detail a," + waras.Schema + ".form7_khata b", "a.khata_no,(max(a.usrno))+1 as usrno ", "a.ccode=b.ccode and a.ccode = '" + (string)waras.Ccode + "' and replace(a.fname||a.mname||a.lname||a.topan_name,' ','') = replace('" + Convert.ToString(DS_MKS.Tables[0].Rows[0]["fname"])  + Convert.ToString(DS_MKS.Tables[0].Rows[0]["mname"]) + Convert.ToString(DS_MKS.Tables[0].Rows[0]["lname"]) +  Convert.ToString(DS_MKS.Tables[0].Rows[0]["topan_name"]) + "',' ','') and a.fname = b.fname and a.mname = b.mname and a.lname = b.lname and a.topan_name = b.topan_name and a.khata_no=b.khata_no Group by a.khata_no", "khata_no");
                            if (DS_F7K.Tables[0].Rows.Count > 0)
                            {
                                ...
                                for (int i = 0; i <= DS_F7K.Tables[0].Rows.Count - 1; i++) //survey number loop
                                {
                                    ...
                                    if (DS_F7K.Tables[0].Rows[i][1].ToString() == "1" && DS_MKB.Tables[0].Rows.Count > 1)
                                        objclscommonfunedit.funUpdateValueSevarthID(waras.Database, waras.Schema + ".holder_detail", "khata_type =2", "ccode = '" + waras.Ccode + "'and replace(fname||mname||lname||topan_name,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6]  + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8]  + DS_MKS.Tables[0].Rows[0][9] + "',' ','') AND khata_type = 1", loginid, ref dbCmd4);
                        ...
                        //objclscommonfunedit.funUpdateValueSevarthID(waras.Database, waras.Schema + ".mut_kharedi", "or_code4=1", "ccode = '" + waras.Ccode + "'and pin='" + waras.Pin + "' and pin1='" + waras.Pin1 + "' and  pin2='" + waras.Pin2 + "' and pin3='" + waras.Pin3 + "' and pin4='" + waras.Pin4 + "' and pin5='" + waras.Pin5 + "' and pin6='" + waras.Pin6 + "'  and pin7='" + waras.Pin7 + "' and pin8 ='" + waras.Pin8 + "'", loginid, ref dbCmd4);
                        // }
                        ...
                        //4.11012016 update for tblrordetails 
                        objclscommonfunedit.funUpdateValueSevarthID(waras.Database, waras.Schema + ".tblrordetails", "pending_mut_flag='F'", " ccode = '" + waras.Ccode + "' and mutationno=" + waras.Val , loginid, ref dbCmd4);
                        //int y = 0;
                ...
                if (DS_MK.Tables[0].Rows.Count > 0)
                {
                    for (int x = 0; x <= DS_MK.Tables[0].Rows.Count - 1; x++)
                    {
                        if (DS_MK.Tables[0].Rows[0].ItemArray[0].ToString() == "64")
                        {
                            ...
                            DS_MKS = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".mut_kharedi_seller", "*", "mut_no='" + waras.Val + "' and ccode = '" + waras.Ccode + "'and pin='" + waras.Pin + "' and pin1='" + waras.Pin1 + "' and  pin2='" + waras.Pin2 + "' and pin3='" + waras.Pin3 + "' and pin4='" + waras.Pin4 + "' and pin5='" + waras.Pin5 + "' and pin6='" + waras.Pin6 + "'  and pin7='" + waras.Pin7 + "' and pin8 ='" + waras.Pin8 + "' and seller_usrno=64 and seller_name='YES'", "");
                            //2.21/12/2015 mut_no update in form7_khata of those records which are currently live of dieseased person from from7_khata  by putting condition marked <>'Y'
                            objclscommonfunedit.funUpdateValue(waras.Database, waras.Schema + ".pre_form7_khata", "marked='Y', old_mut_no=mut_no, mut_no='" + waras.Val + "'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] +  DS_MKS.Tables[0].Rows[0][8] + "',' ','') and marked<>'Y'", ref dbCmd4);
                            objclscommonfunedit.funUpdateValue(waras.Database, waras.Schema + ".pre_holder_detail", "marked='Y'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "',' ','')", ref dbCmd4);
                            if (DS_MKS.Tables[0].Rows.Count > 0)
                            {
                                //1.21/12/2015 for processing waras mutation select currently only live names of dieseased person from from7_khata and holder_detail by putting condition marked <>'Y'
                                DS_F7K = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".form7_khata a," + waras.Schema + ".pre_holder_detail b", "a.khata_no,b.khata_type,a.numeric_pin,a.pin,a.pin1,a.pin2,a.pin3,a.pin4,a.pin5,a.pin6,a.pin7,a.pin8,a.mut_no,count(*) as usrno,avg(a.total_area_h),avg(a.assessment),avg(a.anne),avg(a.pai),avg(potkharaba)", "a.ccode = b.ccode and a.khata_no = b.khata_no and a.marked<>'Y' and b.marked<>'Y' and a.ccode = '" + waras.Ccode + "' and replace(a.fname||a.mname||a.lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "',' ','') Group by a.khata_no,b.khata_type,a.numeric_pin,a.pin,a.pin1,a.pin2,a.pin3,a.pin4,a.pin5,a.pin6,a.pin7,a.pin8,a.mut_no", "");
                                ...
                                if (DS_F7K.Tables[0].Rows.Count > 0)
                                {
                                    ...
                                    for (int i = 0; i <= DS_F7K.Tables[0].Rows.Count - 1; i++) //survey number loop
                                    {
                                        ...
                                        foreach (DataRow dr in dskhata_usrno.Tables[0].Select("khata_no='" + DS_F7K.Tables[0].Rows[i]["khata_no"].ToString() + "'"))
                                            usrnoMax = Convert.ToInt32(dr["usrno"]);
                                        if (DS_F7K.Tables[0].Rows[i][1].ToString() == "1" && DS_MKB.Tables[0].Rows.Count > 1)
                                            objclscommonfunedit.funUpdateValue(waras.Database, waras.Schema + ".pre_holder_detail", "khata_type =2", "ccode = '" + waras.Ccode + "'and replace(fname||mname||lname||topan_name,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + DS_MKS.Tables[0].Rows[0][9] + "',' ','') AND khata_type = 1", ref dbCmd4);
                                        ...
                                        if (DS_MKB.Tables[0].Rows.Count > 0)
                                        {
                                            ...
                                            for (int j = 0; j <= DS_MKB.Tables[0].Rows.Count - 1; j++) // new waras names 
                                            {
                                                ...
                                                if (i5 == 0)
                                                {
                                                    //3.21/12/2015  potkharaba not updated : retrive and insert potkharaba area
                                                    if (DS_F7K.Tables[0].Rows[i][1].ToString() == "1" && j == 0)//***************for single New Khata
                                                        objclscommonfunedit.funInserSingleValue(waras.Database, waras.Schema + ".pre_form7_khata", "ccode, pin, pin1, pin2, pin3, pin4, pin5, pin6,pin7, pin8,fname,mname,lname,topan_name,khata_no,usrno, old_mut_no,mut_no,total_area_h,assessment,anne,pai,potkharaba", "'" + waras.Ccode + "','" + DS_F7K.Tables[0].Rows[i][3].ToString() + "', '" + DS_F7K.Tables[0].Rows[i][4].ToString() + "','" + DS_F7K.Tables[0].Rows[i][5].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][6].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][7].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][8].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][9].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][10].ToString() + "','" + DS_F7K.Tables[0].Rows[i][11].ToString() + "','" + DS_MKB.Tables[0].Rows[k][20] + "','" + DS_MKB.Tables[0].Rows[k][21] + "','" + DS_MKB.Tables[0].Rows[k][22] + "','" + DS_MKB.Tables[0].Rows[k][23] + "'," + DS_F7K.Tables[0].Rows[i][0].ToString() + "," + usrnoMax + "," + DS_F7K.Tables[0].Rows[i][12].ToString() + ",'" + waras.Val + "', " + Convert.ToDecimal(DS_F7K.Tables[0].Rows[i][14]) + "," + Convert.ToDecimal(DS_F7K.Tables[0].Rows[i][15]) + "," + Convert.ToInt32(DS_F7K.Tables[0].Rows[i][16]) + "," + Convert.ToInt32(DS_F7K.Tables[0].Rows[i][17]) + " ," + DS_F7K.Tables[0].Rows[i][18] + "", ref dbCmd4);
                                                    else
                                                    {
                                                        if (j == 0)
                                                            objclscommonfunedit.funInserSingleValue(waras.Database, waras.Schema + ".pre_form7_khata", "ccode,  pin, pin1, pin2, pin3, pin4, pin5, pin6,pin7, pin8,fname,mname,lname,topan_name,khata_no,usrno, old_mut_no,mut_no,total_area_h,assessment,anne,pai,potkharaba", "'" + waras.Ccode + "' ,'" + DS_F7K.Tables[0].Rows[i][3].ToString() + "', '" + DS_F7K.Tables[0].Rows[i][4].ToString() + "','" + DS_F7K.Tables[0].Rows[i][5].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][6].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][7].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][8].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][9].ToString() + "' ,'" + DS_F7K.Tables[0].Rows[i][10].ToString() + "','" + DS_F7K.Tables[0].Rows[i][11].ToString() + "','" + DS_MKB.Tables[0].Rows[k][20] + "','" + DS_MKB.Tables[0].Rows[k][21] + "','" + DS_MKB.Tables[0].Rows[k][22] + "','" + DS_MKB.Tables[0].Rows[k][23] + "'," + DS_F7K.Tables[0].Rows[i][0].ToString() + "," + usrnoMax + "," + DS_F7K.Tables[0].Rows[i][12].ToString() + ",'" + waras.Val + "', " + Convert.ToDecimal(DS_F7K.Tables[0].Rows[i][14]) + "," + Convert.ToDecimal(DS_F7K.Tables[0].Rows[i][15]) + "," + Convert.ToInt32(DS_F7K.Tables[0].Rows[i][16]) + "," + Convert.ToInt32(DS_F7K.Tables[0].Rows[i][17]) + "," + DS_F7K.Tables[0].Rows[i][18] + "", ref dbCmd4);
        ...
        public string talathi_certifyWaras(objCertify waras, DbCommand dbCmd4)
        {
            ...
            DS_MK = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".verify_mut_kharedi", "or_code3", "mut_no=" + waras.Val + " and ccode = '" + waras.Ccode + "'and pin='" + waras.Pin + "' and pin1='" + waras.Pin1 + "' and  pin2='" + waras.Pin2 + "' and pin3='" + waras.Pin3 + "' and pin4='" + waras.Pin4 + "' and pin5='" + waras.Pin5 + "' and pin6='" + waras.Pin6 + "'  and pin7='" + waras.Pin7 + "' and pin8 ='" + waras.Pin8 + "'", "");
            ...
            if (DS_MK.Tables[0].Rows.Count > 0)
            {
                for (int x = 0; x <= DS_MK.Tables[0].Rows.Count - 1; x++)
                {
                    if (DS_MK.Tables[0].Rows[0].ItemArray[0].ToString() == "64")
                    {
                        ...
                        DataSet DS_F7K = new DataSet();
                        DataSet DS_MKB = new DataSet();
                        DS_MKB = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".verify_mut_kharedi_buyer", "*", "mut_no='" + waras.Val + "' and ccode = '" + waras.Ccode + "'and pin='" + waras.Pin + "' and pin1='" + waras.Pin1 + "' and  pin2='" + waras.Pin2 + "' and pin3='" + waras.Pin3 + "' and pin4='" + waras.Pin4 + "' and pin5='" + waras.Pin5 + "' and pin6='" + waras.Pin6 + "'  and pin7='" + waras.Pin7 + "' and pin8 ='" + waras.Pin8.ToString() + "' and buyer_doc_type1=64", "");
                        DS_MKS = objclscommonfunedit.funReturnDataSet(waras.Database, waras.Schema + ".verify_mut_kharedi_seller", "*", "mut_no='" + waras.Val + "' and ccode = '" + waras.Ccode + "'and pin='" + waras.Pin + "' and pin1='" + waras.Pin1 + "' and  pin2='" + waras.Pin2 + "' and pin3='" + waras.Pin3 + "' and pin4='" + waras.Pin4 + "' and pin5='" + waras.Pin5 + "' and pin6='" + waras.Pin6 + "'  and pin7='" + waras.Pin7 + "' and pin8 ='" + waras.Pin8 + "' and seller_usrno=64 and seller_name='YES'", "");
                        //2.21/12/2015 mut_no update in form7_khata of those records which are currently live of dieseased person from from7_khata  by putting condition marked <>'Y'
                        objclscommonfunedit.funUpdateValue(waras.Database, waras.Schema + ".pre_form7_khata", "marked='Y', old_mut_no=mut_no, mut_no='" + waras.Val + "'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "',' ','') and marked<>'Y'", ref dbCmd4);
                        objclscommonfunedit.funUpdateValue(waras.Database, waras.Schema + ".pre_holder_detail", "marked='Y'", "ccode = '" + waras.Ccode + "' and  replace(fname||mname||lname,' ','') = replace('" + DS_MKS.Tables[0].Rows[0][6] + DS_MKS.Tables[0].Rows[0][7] + DS_MKS.Tables[0].Rows[0][8] + "',' ','')", ref dbCmd4);
                        if (DS_MKS.Tables[0].Rows.Count > 0)
